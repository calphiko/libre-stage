...
<!-- Passwort ändern Bereich -->
  <div class="mt-9">
    <h3 class="text-xl font-semibold mb-3 text-on-surface">Passwort ändern</h3>
    <form class="flex flex-col gap-5">

      <div class="flex flex-col md:flex-row md:items-center gap-2">
        <label class="min-w-[140px] text-on-surface-variant mb-1 md:mb-0">Altes Passwort</label>
        <input type="password"
