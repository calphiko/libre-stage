...
<script>
  ...
  import { getSeasonStatistics, getGenrePalette } from '$lib/api.js';
    ...
    {:else if statistics}
      ...
      <div class="grid grid-cols-3 md:grid-cols-6 gap-3">
        ...
        <div class="card variant-ghost-secondary p-3 text-center rounded-lg">
          <div class="text-2xl font-bold text-secondary-500">{statistics.total_songs ?? statistics.total_songs} / {statistics.planned_songs ?? statistics.total_songs} </div>
