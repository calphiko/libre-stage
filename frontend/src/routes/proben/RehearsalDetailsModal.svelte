...
<div class="card p-4 md:p-5 w-[96vw] max-w-6xl h-[90vh] flex flex-col modal-base reh-modal-compact text-sm">
  ...
  <header class="mb-3 flex items-start justify-between gap-3 border-b border-outline-variant pb-2.5 flex-shrink-0">
    <div>
  ...
  {#if isPast}
    <div class="prose prose-sm dark:prose-invert max-w-none text-xs text-on-surface leading-relaxed">
      {#if reh.comment}
